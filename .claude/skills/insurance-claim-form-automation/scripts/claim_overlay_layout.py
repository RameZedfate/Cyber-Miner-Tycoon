...
LAYOUTS = {
    ...
    "kgi": {
        ...
        "fields": {
            "name": (101.1, 103.3, 197.4, 130.7),
            "identity": (257.0, 103.3, 363.1, 130.7),
            "birth_year": (428.9, 103.3, 467.6, 130.7),
            "birth_month": (472.1, 103.3, 508.1, 130.7),
            "birth_day": (512.6, 103.3, 547.8, 130.7),
            "accident_year": (136.4, 203.3, 158.2, 220.7),
            "accident_month": (161.6, 203.3, 172.1, 220.7),
            "accident_day": (175.6, 203.3, 197.4, 220.7),
            "occupation": (243.6, 203.3, 327.9, 220.7),
            "narrative": (352.6, 203.3, 547.8, 254.8),
            "account_holder": (120, 291, 293, 314),
            "bank": (94.8, 318, 148.8, 331),
            "branch": (94.8, 335, 148.8, 348),
            "beneficiary_identity": (442.0, 646, 536.4, 658),
            "address": (289.5, 701, 537.4, 712),
            "mobile": (397.7, 720, 537.5, 730.3),
        },
        "checks": {
        ...
        "segments": {
            "account": {"rect": (295.4, 314.5, 547.8, 351.1), "count": 14},
        },
    },
    "hontai": {
        "page": (595.32, 841.92),
