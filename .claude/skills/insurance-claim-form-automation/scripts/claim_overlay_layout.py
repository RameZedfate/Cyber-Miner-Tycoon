...
LAYOUTS = {
    ...
    "kgi": {
        ...
        "fields": {
            "name": (104, 106, 194, 128),
            "identity": (260, 106, 360, 128),
            "birth_year": (431, 106, 465, 128),
            "birth_month": (474, 106, 506, 128),
            "birth_day": (515, 106, 545, 128),
            "accident_year": (137, 206, 158, 219),
            "accident_month": (161.8, 206, 172, 219),
            "accident_day": (175.8, 206, 197, 219),
            "occupation": (246, 206, 325, 218),
            "narrative": (355, 206, 545, 269),
            "account_holder": (121, 293, 293, 313),
            "bank": (93, 320, 146, 332),
            "branch": (93, 336, 146, 348),
            "address": (291, 701.5, 536, 714),
            "mobile": (400, 721, 535, 731),
        },
        "checks": {
            "general_medical": (389.2, 172.3, 398.2, 181.3),
            "bank_transfer": (92.3, 277.2, 101.3, 286.2),
            "beneficiary_account": (155.3, 277.2, 164.3, 286.2),
        },
        "segments": {
            "account": {"rect": (295.4, 314.5, 548.1, 351.1), "count": 14},
        },
    },
    "hontai": {
        "page": (595.32, 841.92),
    ...
    "taiwan_life": {
        ...
        "fields": {
            "name": (77, 299, 158, 321),
            "identity": (220, 299, 300, 321),
            "birth_year": (354, 304.5, 380, 315.5),
            "birth_month": (391, 304.5, 405, 315.5),
            "birth_day": (416, 304.5, 426, 315.5),
            "mobile": (495, 299, 569, 320),
            "accident_year": (367, 110.1, 388, 121.1),
            "accident_month": (400, 110.1, 421, 121.1),
            "accident_day": (433, 110.1, 454, 121.1),
            "narrative": (80, 158, 565, 180),
            "account_holder": (41, 372, 158, 385),
            "beneficiary_identity": (162, 372, 300, 385),
            "bank": (303, 372, 435, 385),
            "branch": (438, 372, 570, 385),
        },
        "checks": {
            "personal_insurance": (80.5, 41.9, 91.6, 53.0),
            "medical": (80.5, 54.4, 91.6, 65.4),
            "accident": (130.1, 110.1, 141.1, 121.1),
            "new_event": (245.7, 110.1, 256.7, 121.1),
            "mail_policy_address": (121.1, 463.5, 133.5, 473.3),
        },
        "segments": {
            "bank_code": {"rect": (49.7, 385.9, 106.7, 404.8), "count": 3},
            "branch_code": {"rect": (125.7, 385.9, 201.7, 404.8), "count": 4},
            "account": {"rect": (220.7, 385.9, 486.7, 404.8), "count": 14},
        },
    },
    "prudential": {
        "page": (595.2, 841.92),
