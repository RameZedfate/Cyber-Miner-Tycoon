...
LAYOUTS = {
    ...
    # ------------------------------------------------------------------
    # 以下四組由實際空白表單的向量格線與字元框重建，並以 200 DPI 逐欄目視確認。
    # 鍵值帶版次：不同版次的表單座標不通用，遇到別的版次要重新對版。
    # ------------------------------------------------------------------
    "nanshan_115_04": {
        "page": (595.32, 842.04),
        "edition": "115/04/01",
        "fields": {
            ...
            "birth_year": (332, 163, 364, 180),
            "birth_month": (374, 163, 394, 180),
            "birth_day": (404, 163, 424, 180),
            "mobile": (441, 163, 572, 180),
            "address_city": (152, 183.5, 189, 197),
            "address_district": (208, 183.5, 252, 197),
            "address_road": (343, 183.5, 396, 197),
            "address_lane": (440, 183.5, 456, 197),
            "address_number": (491, 183.5, 507, 197),
            # 「意外事故內容」區塊的經過欄，整格 (107,478)-(573,504)，
            # 印刷說明佔掉 y479.9-491.9，實際只剩下面約一行
            "narrative": (110, 492, 571, 503.5),
            "account_holder": (85, 229, 177, 248),
            "bank": (406, 228, 453, 249),
            "branch": (476, 228, 537, 249),
        },
        "checks": {
            "personal_policy": (98.8, 66.8, 106.4, 74.4),
            "remit_to_beneficiary": (55.1, 201.0, 67.1, 213.0),
            "bank_account": (314.2, 233.5, 323.2, 242.5),
            "disease": (111.7, 390.5, 123.7, 402.5),
            "medical": (211.1, 381.6, 222.1, 392.7),
        },
        "segments": {"account": {"rect": (246, 258, 496, 272), "count": 14}},
        "formats": {"city_district_full_names": True, "address_number": "digits_only"},
    },
    "taiwanlife_ca03": {
        "page": (595.32, 841.92),
        "edition": "CA03",
        "fields": {
            "name": (77, 300, 158, 320),
            "identity": (220, 300, 301, 320),
            "birth_year": (359, 300, 381, 320),
            "birth_month": (390.5, 300, 406, 320),
            "birth_day": (415.5, 300, 427.5, 320),
            "mobile": (495, 300, 569, 320),
            # 事故種類區塊的經過欄，整格 (75,126)-(571,178)，
            # 印刷標題佔 y130-141、括號說明佔 y146.5-155.5，可寫區在其下
            "narrative": (78, 156.5, 569, 177.5),
            "account_holder": (80, 359, 158, 372),
            "beneficiary_identity": (163, 371, 300, 384),
            "bank": (304, 371, 434, 384),
            "branch": (438, 371, 569, 384),
        },
        "checks": {
            "personal_insurance": (80.5, 41.9, 91.6, 53.0),
            "medical": (80.5, 54.4, 91.6, 65.4),
            "non_accident": (80.5, 110.1, 91.6, 121.1),
            "relation_self": (334.8, 281.1, 345.8, 292.1),
            "policy_address_mail": (121.2, 462.3, 132.2, 473.3),
        },
        "segments": {"account": {"rect": (220.6, 386, 486.6, 405), "count": 14}},
    },
    "yuanta_202506": {
        "page": (595.32, 841.92),
        "edition": "202506",
        "fields": {
            "name": (114, 148, 210, 164),
            "identity": (285, 148, 388, 164),
            "birth": (462, 148, 559, 164),
            "address": (114, 166, 350, 182),
            "mobile": (114, 185, 210, 200),
            "occupation": (462, 185, 559, 200),
            "accident_date": (109, 209, 211, 222),
            "diagnosis": (134, 225, 308, 242),
            "surgery": (350, 225, 559, 242),
            "account_holder": (82, 389, 184, 401),
            "beneficiary_identity": (272, 389, 365, 401),
            "bank": (96, 412, 180, 424),
            "branch": (230, 412, 314, 424),
            "account": (368, 412, 528, 424),
        },
        "checks": {
            "personal_insurance": (517.0, 75.8, 526.0, 84.8),
            "medical": (114.5, 93.5, 123.5, 102.5),
            "disease": (469.1, 212.5, 478.1, 221.5),
            "remit_to_beneficiary": (53.9, 315.6, 62.9, 324.6),
        },
        "segments": {},
    },
    "farglory_11501": {
        ...
        "fields": {
            "name": (112, 78, 281, 103),
            "birth_year": (354, 91, 423, 104),
            "birth_month": (437, 91, 489, 104),
            "birth_day": (503, 91, 555, 104),
            "occupation": (383, 194, 431, 209),
            "narrative": (46, 258.5, 579, 270.5),
            "account_holder": (44, 333, 137, 351),
            "bank": (141, 333, 222, 351),
            "branch": (226, 333, 323, 351),
            "mobile": (66, 644, 176, 656),
        },
        "checks": {
            "medical": (47.3, 129.8, 57.7, 140.2),
            "disease": (117.9, 195.3, 128.3, 205.7),
            "remit_to_beneficiary": (153.0, 305.0, 163.4, 315.4),
            "same_latest_address": (58.9, 669.3, 67.9, 678.3),
        },
        "segments": {
            "identity": {"rect": (352, 76.5, 580.5, 89.5), "count": 10},
            "account": {"rect": (325, 333, 580, 351), "count": 14},
        },
    },
}
