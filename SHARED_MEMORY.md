...
- 2026-07-30：**自製技能 `/dm-outreach`（IG／FB 私訊開發客戶＋增員）。這是第一個本 repo 原創、無上游的技能。**
  ...
  - ✅ **已完成設定訪談，建立 `context/outreach-profile.md`**（使用者貼了 3 張真實限動回覆截圖）。
    - 🔑 **抓到他的招牌句型：拋一個「可能會錯」的觀察，不用問句。**
      「衣服好像沖繩買的衣服！」「中間C位很顯眼哈哈」「看起來只有開合跳三十下最容易達成🤣」
      —— 三則全部零問號、一行、句尾一個表情。對方會忍不住糾正或認同，回覆動機來自這裡。
      **猜錯比猜對好**（對方澄清時講出的資訊量更高）。
    - ❗ **找到他最大的漏洞：對方回了有內容的訊息，他只按表情就結束。** 三則裡有兩則這樣。
      按表情 ＝ 禮貌收尾 ＝ 對話關掉。已寫成規則進 profile。
    - 他的自我介紹原話偏「完整版」且專業腔（資產重置／遺產贈與），
      已補「最輕版」「中版」草案待他確認。⚠️ 注意這幾個詞已接近商品功能，別跨進招攬。
    - 話題彈藥：旅遊（沖繩／日本熟）、便宜機票、AI 工具、**八卦**（跟他的句型天生搭配）。
    - 客戶線 ／ 增員線 ＝ 50% ／ 50%。
